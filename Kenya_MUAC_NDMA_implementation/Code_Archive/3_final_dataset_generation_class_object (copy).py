...
muac_data = pd.read_pickle(
    os.path.join(INPUT,
                 'Kenya_NDMA_MUAC_ward_level_2021_01_to_2025_06.pkl'))
new_muac_data = pd.read_pickle(
    os.path.join(INPUT,
                 'Kenya_NDMA_MUAC_23_counties_Jul_2025_WARD_LEVEL.pkl'))
min_num_obs_ward = 35
    ...
    def merge_temperature_data(self, 
        ...
        if os.path.exists(new_path):
            try:
                ...
                # Build new filename
                new_filename = f"era5_temperature_stats_{start_date}_to_{end_date}.pkl"
    ...
    def merge_precipitation_data(self, 
        ...
        if os.path.exists(new_path):
            try:
                ...
                # Build new filename
                new_filename = f"chirps_precipitation_stats_{start_date}_to_{end_date}.pkl"
    ...
    def merge_ndvi_evi_data(self, 
        ...
        if os.path.exists(new_path):
            try:
                ...
                # Build new filename
                new_filename = f"modis_ndvi_evi_stats_{start_date}_to_{end_date}.pkl"
    ...
    def merge_ndvi_evi_by_land_use(self,
        ...
        if os.path.exists(new_path):
            try:
                ...
                # Build new filename
                new_filename = f"modis_evi_by_land_use_stats_{start_date}_to_{end_date}.pkl"
    ...
    def merge_land_use_data(self, 
        ...
        if os.path.exists(new_path):
            try:
                ...
                # Build new filename
                new_filename = f"land_use_pct_stats_{start_date}_to_{end_date}.pkl"
    ...
    def merge_conflict_data(self,
        ...
        if os.path.exists(c100_path_new):
            try:
                ...
                # Build new filename
                new_filename = f"ACLED_conflict_12m_100kmcutoff_{start_date}_to_{end_date}.pkl"
        ...
        if os.path.exists(c500_path_new):
            try:
                ...
                # Build new filename
                new_filename = f"ACLED_conflict_12m_500kmcutoff_{start_date}_to_{end_date}.pkl"
...
builder.merge_temperature_data(main_file="era5_temperature_stats_2004_01_to_2025_06.pkl",
                            new_file="era5_stats_2025_07_to_2025_07.pkl",
                            baseline_years=(2004, 2020),
                            analysis_years=(2021, 2025))

builder.merge_precipitation_data(main_file="chirps_precipitation_stats_2004_01_to_2025_06.pkl",
                                new_file="chirps_stats_2025_07_to_2025_07.pkl",
                                baseline_years=(2004, 2020),
                                analysis_years=(2021, 2025))

builder.merge_ndvi_evi_data(main_file="modis_ndvi_evi_stats_2016_01_to_2025_06.pkl",
                            new_file="modis_ndvi_evi_stats_2025_07_to_2025_07.pkl",
                            baseline_years=(2016, 2020),
                            analysis_years=(2021, 2025))

builder.merge_ndvi_evi_by_land_use(main_file="modis_evi_by_land_use_stats_2016_01_to_2025_06.pkl",
                            new_file="modis_evi_by_land_use_stats_2025_07_to_2025_07.pkl",
                            baseline_years=(2016, 2020),
                            analysis_years=(2021, 2025))

builder.merge_land_use_data(main_file="land_use_pct_stats_2016_01_to_2025_06.pkl",
                            new_file="land_use_pct_stats_2025_07_to_2025_07.pkl")

builder.merge_conflict_data(conflict_100km_old="ACLED_conflict_12m_100kmcutoff_2021_08_to_2025_06.pkl",
                            conflict_100km_new="ACLED_conflict_12m_running_sum_by_polygon_100kmcutoff_Jul_2025.pkl",
                            conflict_500km_old="ACLED_conflict_12m_500kmcutoff_2021_08_to_2025_06.pkl",
                            conflict_500km_new="ACLED_conflict_12m_running_sum_by_polygon_500kmcutoff_Jul_2025.pkl",
                            filter_from_year=2021)
