...
def run_precip_forecast_pipeline(prep_df):
    ...
    def evaluate_model(model, X_test, y_test, scaler, target_var_idx, full_scaled_data):
        ...
        y_test_rescaled = y_test_rescaled[valid]
        y_pred_mean_rescaled = y_pred_mean_rescaled[valid]
        y_pred_std_rescaled = y_pred_std_rescaled[valid]
    ...
    # ----------------------------- #
    data = prep_df.sort_values(['year', 'month_num']).copy()
